...
export default function ProfilePage() {
  ...
  const uploadProfile = async () => {
    ...
    try {
      const res = await axios.post("/upload/profile", fd, {
  ...
  const saveName = async () => {
    ...
    try {
      ...
      console.warn(
        "PUT /users/:id failed or unsupported",
        err?.response?.status
      );
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-6 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="mb-3">
              <label htmlFor="profile-email" className="block text-sm mb-1">
                Email
              </label>
              <input
                id="profile-email"
            ...
            <div className="flex gap-3">
              ...
              <label className="inline-block">
                ...
                />
                <span className="px-4 py-2 bg-gray-100 border rounded cursor-pointer text-sm">
                  Choose image
                </span>
              </label>
              <button
